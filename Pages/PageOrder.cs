...
return false;", string.Empty));
        ...
        private void RptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            var isPaied = Utils.EvalBool(e.Item.DataItem, nameof(OrderInfo.IsPaied));
            ...
            ltlGuid.Text = $@"<a href=""{GetRedirectUrl(_siteId, _isPaied, _state, _keyword)}&view={true}&id={id}"">{guid}</a>";
            ...
            ltlState.Text = Utils.GetStateText(isPaied, state);
        ...
        public void BtnState_OnClick(object sender, EventArgs e)
        {
            ...
            var isPaied = Convert.ToBoolean(value.Split('_')[0]);
        ...
        public void BtnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            {
                isPaied = Utils.ToBool(value.Split('_')[0]);
                state = value.Split('_')[1];
            }

            Response.Redirect(GetRedirectUrl(_siteId, isPaied, state, TbSearchKeyword.Text));
        }
    }
}
