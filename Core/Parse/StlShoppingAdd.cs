...
namespace SS.Shopping.Core.Parse
{
    public class StlShoppingAdd
    {
        ...
        //    var cartId = CartRepository.GetCartId(siteId, sessionId, productId);
        //    if (cartId == 0)
        //    {
        //        cartId = CartRepository.Insert(cartInfo);
        //    }
        //    else
        //    {
        //        cartInfo = CartRepository.GetCartInfo(cartId);
        ...
        //        CartRepository.Update(cartInfo);
        //    }
        ...
        public static string Parse(IParseContext context)
        {
            ...
            var apiAddUrl = $"{Context.Environment.ApiUrl}/{Main.PluginId}/apiAdd";
