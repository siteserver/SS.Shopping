...
namespace SS.Shopping.Core.Parse
{
    public static class StlShoppingOrder
    {
        ...
        //    var orderInfo = OrderRepository.GetOrderInfo(guid);
        //    if (orderInfo != null)
        //    {
...
<div class=""order-content order-cont-other"">
  <div class=""order-h3"">
    订单内容
    <a href=""javascript:;"" @click=""openPay()"" class="" go-pay "" v-show=""!orderInfo.isPayed"">继续支付</a>
  </div>
...
");
            ...
            var apiGetUrl = $"{apiUrl}/{Main.PluginId}/ApiOrderGet";
