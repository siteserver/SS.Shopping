...
namespace SS.Shopping.Core.Parse
{
    public static class StlShoppingCart
    {
        ...
        //    CartRepository.Delete(siteId, context.UserName, sessionId);
        //    foreach (var cartInfo in cartInfoList)
        //    {
        //        cartInfo.UserName = context.UserName;
        //        cartInfo.Id = CartRepository.Insert(cartInfo);
        //    }
...
";
            ...
            var apiGetUrl = $"{apiUrl}/{Main.PluginId}/ApiCartGet";
            var apiSaveUrl = $"{apiUrl}/{Main.PluginId}/ApiCartSave";
