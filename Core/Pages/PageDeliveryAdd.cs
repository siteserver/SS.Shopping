...
namespace SS.Shopping.Core.Pages
{
    public class PageDeliveryAdd : Page
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            var deliveryInfo = Main.DeliveryRepository.GetDeliveryInfo(_deliveryId);
            ...
            RptAreas.DataSource = Main.AreaRepository.GetAreaInfoList(_deliveryId);
...
{(string.IsNullOrEmpty(areaInfo.Cities) ? "未选择任何区域" : areaInfo.Cities)}";
        ...
        private bool SaveDelivery()
        {
            ...
            foreach (RepeaterItem repeaterItem in RptAreas.Items)
            {
                ...
                var areaInfo = Main.AreaRepository.GetAreaInfo(areaId);
            ...
            Main.DeliveryRepository.Update(deliveryInfo);
