...
ORDER BY {SortField} {SortMode}";
        ...
        {
            get { return Utils.ParseInt(ViewState["CacheDuration"]); }
        ...
        {
            get { return Utils.ParseInt(ViewState["ItemsPerPage"]); }
        ...
        {
            get { return Utils.ParseInt(ViewState["CurrentPageIndex"]); }
        ...
        {
            get { return Utils.ParseInt(ViewState["TotalPages"]); }
        ...
        {
            get { return Utils.ParseInt(ViewState["TotalCount"]); }
        ...
        public override void DataBind()
        {
            ...
            {
                CurrentPageIndex = Utils.ParseInt(Page.Request.QueryString[ParmPage], 1) - 1;
            }
        ...
        private void PageList_Click(object sender, EventArgs e)
        {
            ...
            var pageIndex = Utils.ParseInt(pageList.SelectedValue);
